...
<div className='lg:grid grid-cols-12 gap-12 py-6 flex justify-between max-w-[550px] m-auto lg:max-w-[100%] items-center'>
<div className='col-span-6 lg:col-span-2'> <Link href="/">  <Image alt='logo' src="/transparent-logo.png" width="60" height="60" /></Link>
</div>
